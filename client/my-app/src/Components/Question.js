...
function Question() {
    return (
        <div className="flex flex-row justify-center items-center text-semibold p-1 " >
            <Link to="/questino/:id" className="border-b border-gray-200 flex justify-begin items-begin bg-white text-gray-800 hover:bg-gray-200 focus:bg-gray-200 w-4/5 rounded-lg shadow-md">
